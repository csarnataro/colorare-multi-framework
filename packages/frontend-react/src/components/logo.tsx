...
const Logo = ({ additionalCssClass = '', size = 8, font = 'base' }: LogoProps) => {

    const sizeCssClasses = `h-${size}`;
    return (
        <h1 className={`block text-${font} tracking-wide mb-4 font-bold ${sizeCssClasses} ${additionalCssClass}`} style={{textShadow: '#A3A3A3 1px 1px 1px'}}>
